...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionclassification = QAction(MainWindow)
        self.actionclassification.setObjectName(u"actionclassification")
        self.actionclassification.setCheckable(True)
        self.actionclassification.setChecked(False)
        icon4 = QIcon()
        icon4.addFile(u"classification-icon-512x512-cjfcdh0f.png", QSize(), QIcon.Normal, QIcon.Off)
        self.actionclassification.setIcon(icon4)
        self.actionclassification.setMenuRole(QAction.MenuRole.ApplicationSpecificRole)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionclassification.setText(QCoreApplication.translate("MainWindow", u"classification", None))

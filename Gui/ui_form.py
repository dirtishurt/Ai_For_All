...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.confidence_slider.setContextMenuPolicy(Qt.ContextMenuPolicy.DefaultContextMenu)
        ...
        self.confidence_slider.setInvertedAppearance(False)
        ...
        self.confidence_percent.setMaximumSize(QSize(150, 20))
